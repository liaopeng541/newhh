...
const MyTab = TabNavigator({
    ...
    tabBarOptions:{
        ...
        activeTintColor:'#cc0033', // label和icon的前景色 活跃状态下（选中）。
      ...
      //  inactiveBackgroundColor:'"#cc0033', // label和icon的背景色 不活跃状态下（未选中）。
        ...
        showLabel:true, // 是否显示label，默认开启。
         style:{backgroundColor:"#dddddd",height:56}, // tabbar的样式。
         labelStyle:{marginTop:0,fontSize:12}, //label的样式。
        ...
        // scrollEnabled:false, // 是否启用可滚动选项卡。
         tabStyle:{backgroundColor:"#ffffff"}, // tab的样式。
